...
# shape1: timestep, shape2: nums of features
...
def create_DCNN_model(shape1, shape2):  # Lookback window of the lagged dynamic features
    ...
    model.compile(loss='mse', optimizer=tf.keras.optimizers.legacy.Adam(1e-4), metrics=['mae', 'mse', 'mape'])
